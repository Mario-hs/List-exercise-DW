// 19. Faça um programa que crie uma lista inicializada com 5 números inteiros desordenados e mostre-os em ordem
// crescente.
...
console.log('Lista Ordenada (sort): ', listaInicializada.sort((a, b) => { return a - b }))